      ...
      <div className="flex-1 flex items-center justify-center p-6 relative" style={{ backgroundImage: `url(${loginDoodle})`, backgroundSize: "600px", backgroundRepeat: "repeat", backgroundPosition: "center" }}>
        ...
        <div className="relative z-10 w-full" style={{ maxWidth: "400px" }}>
          ...
          {submitted ? (
            <div className="text-center">
              <div className="w-14 h-14 rounded-2xl flex items-center justify-center mx-auto mb-5" style={{ backgroundColor: "#f0fdfa" }}>
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0d9488" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M22 16.92v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.81a19.79 19.79 0 01-3.07-8.68A2 2 0 012 .18h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L6.09 7.91a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0122 14.9v2.02z" />
                </svg>
              </div>
              <h1 style={{ fontSize: "22px", fontWeight: 700, color: "#0f172a", letterSpacing: "-0.025em" }}>Check your email</h1>
            ...
            <>
              <div className="mb-8">
                <h1 style={{ fontSize: "26px", fontWeight: 700, color: "#0f172a", letterSpacing: "-0.025em", lineHeight: 1.2 }}>Forgot password?</h1>
                <p className="mt-1.5" style={{ fontSize: "14px", color: "#94a3b8" }}>Enter your email and we'll send you a reset link.</p>
              </div>

              <div className="space-y-4">
                <div>
                  <label className="block mb-1.5" style={{ fontSize: "13px", fontWeight: 600, color: "#374151" }}>Email address</label>
                  <input
                    type="email"
                    value={email}
                ...
                <button
                  onClick={() => navigate("/login")}
                  className="w-full py-3 rounded-xl transition-all hover:bg-gray-50"

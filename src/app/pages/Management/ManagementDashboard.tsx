...
// Mirrors Dashboard.tsx (admin) exactly — only the page heading differs.
// All three dashboard API endpoints already allow ROLES.MANAGEMENT on the backend.
    ...
    <div className="p-8 max-w-[1200px] mx-auto">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
        <SectionHeader
          ...
          onAction={() => navigate("/management/attendance")}
        />
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 mb-6">
        <SectionHeader
          ...
          actionLabel="View All"
          onAction={() => navigate("/management/tests")}
        />
        <div className="overflow-hidden rounded-xl border border-gray-100">
          <table className="w-full">
            <thead>
        ...
        <div className="col-span-3">
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            <SectionHeader
              title="Announcements"
              actionLabel="View All"
              onAction={() => navigate("/management/announcements")}
            />
